...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self displayImage:imageViewLeft withImage:[UIImage imageNamed:[NSString stringWithFormat:@"%li_iphone",(imageIndex * 2)-1]]];
     [self displayImage:imageViewRight withImage:[UIImage imageNamed:[NSString stringWithFormat:@"%li_iphone",(imageIndex * 2)-2]]];
    return cell;
}
